...
from tensorflow.compat.v1 import Session, get_default_graph, GPUOptions, ConfigProto
...
#     im_data = cv2.imread("/static/tmp/tmp.jpg")

#     x1, y1, x2, y2 = face_utils_cls_tool.detection_face_by_tf(im_data)
#     #x1, y1, x2, y2 = face_utils_cls_tool.detection_face_by_dlib(im_data)
#     sp = im_data.shape ##
